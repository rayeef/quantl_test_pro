'''
The following presents Python code with a class for the event-based backtesting
of long-only strategies, with implementations
for strategies based on SMAs, momentum, and mean reversion:
'''
...
if __name__ == '__main__':
    def run_strategies():
        ...
        lobt.run_sma_strategy(21, 50)
        # lobt.run_momentum_strategy(60)
    #     lobt.run_mean_reversion_strategy(50, 5)
    lobt = BacktestLongOnly("SPY","2010-01-01","2021-09-09", 10000,
                            verbose=False)
    # run_strategies()
    # transaction costs: 10 USD fix, 1% variable
    # lobt = BacktestLongOnly("FTNT","2010-01-01","2021-10-30",
    #                         10000, 10.0, 0.01, False)
    run_strategies()

    # lobt.get_date_price(2900)
    # lobt.print_balance(2900)
    lobt.plot_data()
