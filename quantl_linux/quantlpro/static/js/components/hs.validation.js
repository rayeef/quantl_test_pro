...
;(function ($) {
  ...
  $.HSCore.components.HSValidation = {
    ...
    init: function (selector, config) {
      ...
      jQuery.validator.addMethod("rangeValue", function(value, element) {
    ...
    highlight: function (element) {
      ...
      $this.parents('.input-group-merge').addClass('input-group-merge-error');
    ...
    unHighlight: function (element) {
      ...
      $this.parents('.input-group-merge').removeClass('input-group-merge-error');
