...
class Spot(API):
    ...
    from .account import get_order_rate_limit
    ...
    from .sub_account import sub_account_api_toggle_ip_restriction
    from .sub_account import sub_account_api_add_ip
    from .sub_account import sub_account_api_get_ip_restriction
    from .sub_account import sub_account_api_delete_ip
    ...
    # CRYPTO LOANS
    from .loan import loan_history

    # PAY
    from .pay import pay_history
